...
def load_kb_training_data() -> Tuple[List[str], List[str]]:
    ...
    examples = [
        # CAPABILITIES_OVERVIEW umbrella: questions about what Pupper can do.
        # These map to multiple source types so the retriever merges boosts.
        ("what can you do", "TOOL_LOOKUP"),
        ("what can you do", "SCRIPT_INFO"),
        ("what can you do", "HOUND_INFO"),
        ("what can you do", "STATUS_REQUEST"),
        ("tell me what you can do", "TOOL_LOOKUP"),
        ("tell me what you can do", "SCRIPT_INFO"),
        ("tell me what you can do", "HOUND_INFO"),
        ("tell me what you can do", "STATUS_REQUEST"),
        ("what are your abilities", "TOOL_LOOKUP"),
        ("what are your abilities", "SCRIPT_INFO"),
        ("what are your abilities", "HOUND_INFO"),
        ("what are your abilities", "STATUS_REQUEST"),
        ("what do you do", "TOOL_LOOKUP"),
        ("what do you do", "SCRIPT_INFO"),
        ("what do you do", "HOUND_INFO"),
        ("what do you do", "STATUS_REQUEST"),
        ("show me what you can do", "TOOL_LOOKUP"),
        ("show me what you can do", "SCRIPT_INFO"),
        ("show me what you can do", "HOUND_INFO"),
        ("show me what you can do", "STATUS_REQUEST"),
        ("list your abilities", "TOOL_LOOKUP"),
        ("list your abilities", "SCRIPT_INFO"),
        ("list your abilities", "HOUND_INFO"),
        ("list your abilities", "STATUS_REQUEST"),
        ("give me an overview of your abilities", "TOOL_LOOKUP"),
        ("give me an overview of your abilities", "SCRIPT_INFO"),
        ("give me an overview of your abilities", "HOUND_INFO"),
        ("give me an overview of your abilities", "STATUS_REQUEST"),
        ("how can you help me", "TOOL_LOOKUP"),
        ("how can you help me", "SCRIPT_INFO"),
        ("how can you help me", "HOUND_INFO"),
        ("how can you help me", "STATUS_REQUEST"),
        ("what are you good at", "TOOL_LOOKUP"),
        ("what are you good at", "SCRIPT_INFO"),
        ("what are you good at", "HOUND_INFO"),
        ("what are you good at", "STATUS_REQUEST"),
        ("what is your job", "TOOL_LOOKUP"),
        ("what is your job", "SCRIPT_INFO"),
        ("what is your job", "HOUND_INFO"),
        ("what is your job", "STATUS_REQUEST"),
